...
final_output = foreach join_medal generate final_filter_gold::Region, final_filter_gold::Gold, final_filter_silver::Silver;

-- order the final medal count
final_order = order final_output by Gold DESC, Region ASC;
store final_order into 'hdfs:///output/task2-1'; 
